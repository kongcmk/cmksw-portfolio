...
const Home = () => {
  ...
  return (
    ...
    `}
      ...
      <div className={`absolute top-[90%] left-1/2 transform translate-y-[-50%]  translate-x-[-50%]
            ${folderOpen ? "hidden" : ""}
      `}>
        <p className="text-sm font-normal text-center opacity-50 animate-bounce">
          click open <span className="italic font-medium uppercase ">"00_portfolio" </span>to show more
        </p>
      </div>
    </div>
  );
